...
inline void InvSubBytes(uchar state[][4])
{
...
inline void InvShiftRows(uchar state[][4])
{
   int t;
   // Shift right by 1
   t = state[1][3];
...
inline void InvMixColumns(uchar state[][4])
{
   int idx;
   uchar col[4],t;
   // Column 1
...
__kernel void aes_decrypt(__global uchar16* in,__global uchar16* out,
